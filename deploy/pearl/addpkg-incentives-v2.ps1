# addpkg incentives/v2 on Pearl. Does not overwrite v1 (100 GNOT program stays there).
...
$Dir = Join-Path $PSScriptRoot "incentives-v2"
$Path = "gno.land/r/g1mv0052e7r6s09f5t9xsqf00nj3tqsgt9dg52jr/zdex/incentives/v2"
...
if (-not $Broadcast) {
  ...
  Write-Host "  .\deploy\pearl\addpkg-incentives-v2.ps1 -KeyName $KeyName -Broadcast"
}
