# addpkg incentives/v3 on Pearl. Does not overwrite v1 (100 GNOT) or v2.
# FundProgram stacks Remaining. Never pass a mnemonic or password as an argument.
param(
...
$Dir = Join-Path $PSScriptRoot "incentives-v3"
$Path = "gno.land/r/g1mv0052e7r6s09f5t9xsqf00nj3tqsgt9dg52jr/zdex/incentives/v3"
...
if (-not $Broadcast) {
  ...
  Write-Host "  .\deploy\pearl\addpkg-incentives-v3.ps1 -KeyName $KeyName -Broadcast"
}
